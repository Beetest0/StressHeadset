    ...
    internal class HIDDevice
    {
        ...
        public static interfaceDetails[] getConnectedDevices()
        {
            ...
            while (b)
            {
                ...
                if (devicePath.Contains("vid_0d8c") || devicePath.Contains("vid_2ea1"))
                {
                    // Console.WriteLine("DEBUG :: {0}", devicePath);
                    ...
                    if (productInfo.VID == 0x0D8C || productInfo.VID == 0x2EA1)
                    {
                        if (productInfo.UsagePage != 0x0C)
                        {
                            if (productInfo.PID != 0x0422 && productInfo.PID != 0x0423 && productInfo.PID != 0x0425)
                                continue;
